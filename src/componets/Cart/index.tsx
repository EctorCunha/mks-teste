...
import { cartIsClose, increment, decrement } from "./cartState";
    ...
    <>
    {
      cart ? <CartContainer>
        <Main>
          ...
          <Products>
            <Product>
              <img src="https://img.freepik.com/fotos-gratis/3d-rendem-de-uma-mesa-de-madeira-com-uma-imagem-defocussed-de-um-barco-em-um-lago_1048-3432.jpg?w=2000" alt="Produto escolhido" style={{width:'50px', height:'50px'}}/>
